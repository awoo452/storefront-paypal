...
This template follows the exact S3 conventions from `templates/s3-image-storage`.
Product images are stored in S3 and referenced by key:
...
Products are purchasable when at least one active variant has stock and pricing.
Leave variant stock blank to mark it out of stock.
